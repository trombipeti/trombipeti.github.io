...
App.prototype.update = function() {
	...
	this.quad.draw(this.gl, this.camera, app.canvas.width, app.canvas.height);
...
App.prototype.pointerLockChange = function(event) {
	this.ownMouse = (this.canvas == document.mozPointerLockElement) || (this.canvas == document.pointerLockElement); 
}
